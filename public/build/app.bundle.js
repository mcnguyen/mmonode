...
var SpaceObject = function SpaceObject(x, y, width, height, title) {
...
var _SpaceNode = __webpack_require__(29);

var _SpaceNode2 = _interopRequireDefault(_SpaceNode);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_SpaceNode2.default, null)
      );
    }
  }]);
...
var _Ship = __webpack_require__(30);

var _Ship2 = _interopRequireDefault(_Ship);

var _Asteroid = __webpack_require__(31);
...
var SpaceNode = function (_Component) {
  _inherits(SpaceNode, _Component);

  function SpaceNode() {
    _classCallCheck(this, SpaceNode);

    var _this = _possibleConstructorReturn(this, (SpaceNode.__proto__ || Object.getPrototypeOf(SpaceNode)).call(this));
  ...
  _createClass(SpaceNode, [{
    ...
    value: function componentDidMount() {
      ...
      this._frameCallback = function (ms) {
        if (lastTime !== null) {
          var diff = ms - lastTime;
          _this2.update(diff / 1000);
        }
        lastTime = ms;
        requestAnimationFrame(_this2._frameCallback);
      };
      requestAnimationFrame(this._frameCallback);

      var sh = new _Ship2.default(320, 240, 2, 4, 'Ship 1');
      var sh1 = new _Ship2.default(500, 400, 2, 4, 'Ship 2');

      var as1 = new _Asteroid2.default(1000, 500, 20, 20, 'Asteroid 1');
      var as2 = new _Asteroid2.default(900, 450, 20, 20, 'Asteroid 2');
      var as3 = new _Asteroid2.default(850, 490, 20, 20, 'Asteroid 3');
      var as4 = new _Asteroid2.default(750, 490, 20, 20, 'Asteroid 4');

      var base1 = new _Base2.default(100, 100, 100, 100, 'Space Station');

      var newShips = Object.assign([], this.state.worldObjects);
      newShips.push(sh);
      newShips.push(sh1);
    ...
    value: function handleCanvasClick(e) {
      ...
      if (this.state.action == ACTION_MOVE) {
        // Move
        var angle = Math.round(Math.atan2(e.clientY - this.state.cam.height / 2, e.clientX - this.state.cam.width / 2) * 180 / Math.PI);
    ...
    value: function handleSelectButtonClick(e) {
      this.setState({ action: ACTION_SELECT });
    }
  }, {
    key: 'handleMoveButtonClick',
    value: function handleMoveButtonClick(e) {
      this.setState({ action: ACTION_MOVE });
    }
  }, {
    key: 'determineClickedObject',
    value: function determineClickedObject(clickX, clickY) {
      ...
      try {
        for (var _iterator = this.state.worldObjects[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var object = _step.value;

          var objectScreenX = object.x - this.state.cam.x;
    ...
    value: function updateCamera() {
      if (this.state.cam.x !== this.state.player.x || this.state.cam.y !== this.state.player.y) {
        var newCamPosition = Object.assign(this.state.cam, {});
    ...
    value: function updateObjects() {
      ...
      try {
        for (var _iterator2 = this.state.worldObjects[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    value: function draw() {
      ...
      try {
        for (var _iterator3 = this.state.worldObjects[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
    ...
    value: function drawTarget() {
      if (this.state.selectedObject !== null) {
        var targetX = this.state.selectedObject.x - this.state.cam.x;
        var targetY = this.state.selectedObject.y - this.state.cam.y;

        var targetWidth = this.state.selectedObject.width;
        var targetHeight = this.state.selectedObject.height;
    ...
    key: 'render',
    value: function render() {
      var selectedText = this.state.selectedObject !== null ? this.state.selectedObject.title : 'None';

      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement('canvas', { style: { zIndex: 1 }, width: this.state.cam.width, height: this.state.cam.height, ref: 'canvas' }),
        _react2.default.createElement('input', { type: 'button', onClick: this.handleSelectButtonClick.bind(this), style: { zIndex: 2, position: 'absolute', top: 10, left: 5 }, value: 'Select' }),
        _react2.default.createElement('input', { type: 'button', onClick: this.handleMoveButtonClick.bind(this), style: { zIndex: 2, position: 'absolute', top: 40, left: 5 }, value: 'Move' }),
        _react2.default.createElement(
          'span',
          { style: { zIndex: 2, position: 'absolute', top: 70, left: 5 } },
          'Selected: ',
          selectedText
        )
      );
...
var _SpaceObject2 = __webpack_require__(7);

var _SpaceObject3 = _interopRequireDefault(_SpaceObject2);
...
var Ship = function (_SpaceObject) {
    _inherits(Ship, _SpaceObject);

    function Ship(x, y, width, height, objectTitle) {
        _classCallCheck(this, Ship);

        return _possibleConstructorReturn(this, (Ship.__proto__ || Object.getPrototypeOf(Ship)).call(this, x, y, width, height, objectTitle));
    }
    ...
    _createClass(Ship, [{
        ...
        value: function update(state) {
            if (this == state.player) {
                ...
                var angle = Math.atan2(state.destination.y - this.y, state.destination.x - this.x) * 180 / Math.PI;
...
var Asteroid = function (_SpaceObject) {
    _inherits(Asteroid, _SpaceObject);

    function Asteroid(x, y, width, height, objectTitle) {
        _classCallCheck(this, Asteroid);

        var _this = _possibleConstructorReturn(this, (Asteroid.__proto__ || Object.getPrototypeOf(Asteroid)).call(this, x, y, width, height, objectTitle));

        _this.vertices = [];

        var size = Math.round(20 + Math.random() * _this.width);
        var numVertices = Math.round(5 + Math.random() * 4);

        var range = 360 / numVertices;

        for (var v = 0; v < numVertices; v++) {
            var randomAngle = range * v + Math.round(Math.random() * range);
            var randomDistance = 10 + Math.round(Math.random() * size);

            var vX = Math.cos(randomAngle * Math.PI / 180) * randomDistance;
            var vY = Math.sin(randomAngle * Math.PI / 180) * randomDistance;

            _this.vertices.push({ x: vX, y: vY });
        }

        _this.velocityX = Math.round(Math.random() * 0.1);
        _this.velocityY = Math.round(Math.random() * 0.1);

        _this.rotationSpeed = Math.random() * 0.06;
...
var Base = function (_SpaceObject) {
    _inherits(Base, _SpaceObject);

    function Base(x, y, width, height, objectTitle) {
        _classCallCheck(this, Base);

        var _this = _possibleConstructorReturn(this, (Base.__proto__ || Object.getPrototypeOf(Base)).call(this, x, y, width, height, objectTitle));

        _this.beaconLast = Date.now();
        _this.beaconState = 0;
        _this.beaconInterval = 25;
        _this.beaconFade = 255;
        _this.beaconRange = 50;
        return _this;
    }
